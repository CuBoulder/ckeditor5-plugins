...
import ColumnContentEditing from './columncontentediting';
import ColumnContentUI from './columncontentui';
import { Plugin } from 'ckeditor5/src/core';

// Note that ColumnContentEditing and ColumnContentUI also extend `Plugin`, but these
  // are not seen as individual plugins by CKEditor 5. CKEditor 5 will only
  // discover the plugins explicitly exported in index.js.
  export default class ColumnContent extends Plugin {
    static get requires() {
      return [ColumnContentEditing, ColumnContentUI];
    }
  }
